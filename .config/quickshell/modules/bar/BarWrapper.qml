...
// Topbar variant of caelestia's sidebar wrapper: the bar occupies the TOP
// border region and grows downward (height axis instead of width).
Item {
    id: root
    ...
    function entryIdAt(pos: real): string {
        return (content.item as Bar)?.entryIdAt(pos) ?? "";
    }
